...
router.put(
  "/practices/practice",
  practiceControler.Practice.validate("createPractice"),
  practiceControler.Practice.createPractice
);

//Get (all) Practices for a user Id
router.get(
  "/practices/user/:id",
  practiceControler.Practice.validate("paramsId"),
  practiceControler.Practice.getUserPractices
);
//GET Practice Info for PracticeId
router.get(
  "/practices/:id/info",
  practiceControler.Practice.validate("paramsId"),
  practiceControler.Practice.getPracticeInfo
);
...
router.get(
  "/practices/:id/drills",
  practiceControler.Practice.validate("paramsId"),
  practiceControler.Practice.getPracticeDetails
);
//GET Search drills (need to be place befor the drills/:id)
router.get("/drills/search/", drillControler.Drill.searchDrill);
//GET Drill by ID (drill_id)
router.get("/drills/:id", practiceControler.Practice.getDrill);
//PUT Create Drills
router.put(
  "/drills/drill",
  drillControler.Drill.validate("createDrill"),
  drillControler.Drill.createDrill
);
