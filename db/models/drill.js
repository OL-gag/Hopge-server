...
class Drills {
  ...
  async createDrill(
    ...
    console.log(
      "*** drill.js - IN after query createDrill **" + text + " -- " + values
    );
    return rows;
  }
  ...
  async searchDrills(query) {
    console.log("*** models/drills.js - search function **");
    var searchQuery = "SELECT drill_id FROM hpg.drills WHERE " + query;
